...
function generateHtmlButton(callback) 
{
    ...
    if (location.protocol == "https:") {
        ...
        myButton.innerHTML = "<img style=' animation-name:displaceContent;animation-duration:1.5s;animation-delay:0.5s;animation-iteration-count :2;animation-fill-mode:forwards;width:100%;' src='img/relais-colis-logo.svg'; />";
    } else {
        myButton.innerHTML = "<img style=' animation-name:displaceContent;animation-duration:1.5s;animation-delay:0.5s;animation-iteration-count :2;animation-fill-mode:forwards;width:100%;' src='img/relais-colis-logo.svg'/>";
    ...
    myButton.setAttribute('style', 'cursor: pointer; min-width: 80px;background-color: #DDAF94;display:flex;flex-direction:column;align-items:center;justify-content:center; ');
